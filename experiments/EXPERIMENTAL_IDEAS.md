...
- **Why:** Multiplier-2 controls produced no functional origins; historical
  entropy-only evidence suggests testing a higher conserved reservoir without
  weakening the endpoint.
- **Hypothesis:** Histogram-matched multiplier 16 yields repeatable strict
  functional origin at the existing scale.
- **Test:** Ten new 32,768-tape × 100,000-epoch seeds under exact conservation
  and the unchanged observer.
- **Preregistration:** `reports/ac_p001_high_resource_origin_viability_preregistration.md`
- **Estimated cost:** high; ten full-scale runs
- **On success:** preregister a new held-out multiplier-16 versus multiplier-2
  comparison.
